...
def attack_setting(args, test_label_poison=True, ret_testset=False):
    if args['dataset'] == 'mnist':
        ...
        trainset = torchvision.datasets.CIFAR10(root='/data/share/ryy/code/RAB1/raw_data', train=True, download=True, transform=transform)
        testset = torchvision.datasets.CIFAR10(root='/data/share/ryy/code/RAB1/raw_data', train=False, download=False, transform=transform)
